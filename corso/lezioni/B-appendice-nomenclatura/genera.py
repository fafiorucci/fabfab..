...
ITEMS=[('pulpito di prua',(962,236)),('musone e rullo dell\'ancora',(1058,276)),('gavone dell\'ancora',(948,310)),('osteriggio',(815,310)),
 ...
 ('rotaia e carrello del genoa',(540,ybot(540)-6)),('tuga',(610,390)),('winch e stopper di tuga',(452,246)),('boccaporto (tambucio)',(375,310)),
...
sec('coperta', head('2 · La coperta','La coperta vista dall\'alto',BLUE), pinned=F.out(b,'Barca a vela vista dall\'alto con la prua a destra e venti particolari numerati: dal pulpito di prua con il musone e il gavone dell\'ancora, all\'albero con strallo, sartie e lande, alla tuga con osteriggi, winch, stopper e boccaporto, fino al pozzetto con trasto, timone a ruota, ombrinali, pulpito e specchio di poppa')+pcol(leg,532,0),
