...
ST={'ril':(NAVY,3,'',False),'ril2':(CORAL,4,'',False),'trasp':(PURPLE,3.5,'14 9',False),'trasp_v':(GREY,2,'6 6',True),'rotta':(GREEN,5,'',True),
    'rotta2':(ORANGE,4,'12 8',True),'rotta_l':(GREY,2,'8 8',False),'vett':(ORANGE,4,'',True),'vett2':(GREEN,3,'8 6',True),'corr':(SEA,5,'',True),'stima':(PURPLE,3,'10 7',True),'par':(PURPLE,2.5,'10 8',False)}
LABC={'corr':SEA,'stima':PURPLE,'ril':NAVY,'ril2':CORAL,'trasp':PURPLE,'rotta':GREEN,'rotta2':ORANGE,'vett':ORANGE,'vett2':GREEN,'lm':NAVY,'ship':'#34465E','fix':CORAL}
