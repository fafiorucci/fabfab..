...
b+=''.join(arrow(x,90,x+120,90,GREY,7,22) for x in (80,380,680))+dpath('M60 560 L1020 560',PURPLE,4)+arrow(900,560,1020,560,PURPLE,4,16)
lbl=lab(X+c1+60,Y+150,420,'lunghezza: da cresta a cresta',NAVY,24,900)+lab(X+tr+180,Y+440,300,'altezza: dalla cresta al cavo',CORAL,24,900,bg='#FFFFFF')+lab(X+80,Y+120,260,'vento',SOFT,24,900)+lab(X+60,Y+500,500,'fetch: il tratto di mare su cui soffia il vento',PURPLE,24,900,bg='#FFFFFF')
